package dev.lbuddyboy.hub.scoreboard.impl;
...
public class QueueScoreboard extends HubScoreboard {
    ...
    public QueueScoreboard() {
        this.config = new Config(lHub.getInstance(), "queue", lHub.getInstance().getScoreboardHandler().getScoreboardDirectory());
    ...
    public boolean qualifies(Player player) {
        ...
        return queueImpl.inQueue(player);
    }
}
