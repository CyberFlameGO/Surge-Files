package dev.lbuddyboy.vouchers.util.menu.paged;

import dev.lbuddyboy.vouchers.util.menu.Menu;
import dev.lbuddyboy.vouchers.util.menu.button.PreviousPageButton;
import dev.lbuddyboy.vouchers.util.menu.Button;
import dev.lbuddyboy.vouchers.util.menu.button.NextPageButton;
