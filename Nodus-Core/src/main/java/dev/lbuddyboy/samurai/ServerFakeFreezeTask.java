...
public final class ServerFakeFreezeTask extends BukkitRunnable {
    ...
    private double avgLatency() {
        ...
        for (Player player : Samurai.getInstance().getServer().getOnlinePlayers()) {
            int playerLatency = player.getPing();
    ...
    private int playerCount() {
        return Samurai.getInstance().getServer().getOnlinePlayers().size();
    }
    ...
    private void freeze() {
        ...
        Samurai.getInstance().getLogger().info("Foxtrot autofreeze would have frozen the server.");
    }
    ...
    private void unfreeze() {
        ...
        Samurai.getInstance().getLogger().info("Foxtrot autofreeze would have unfrozen the server.");
    }
