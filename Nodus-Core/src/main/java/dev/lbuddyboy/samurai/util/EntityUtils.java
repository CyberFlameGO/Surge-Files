...
public final class EntityUtils {
    ...
    static {
        displayNames.put(EntityType.TRIDENT, "Trident");
        displayNames.put(EntityType.WARDEN, "Warden");
        ...
        displayNames.put(EntityType.PIGLIN, "Piglin");
        displayNames.put(EntityType.PIGLIN_BRUTE, "Piglin Brute");
        displayNames.put(EntityType.ZOMBIFIED_PIGLIN, "Zombified Piglin");
