...
import dev.lbuddyboy.samurai.util.loottable.editor.impl.CommandListEdit;
import dev.lbuddyboy.samurai.util.loottable.editor.impl.ToggleGiveItemEdit;
...
public class EditLootTableItemMenu extends Menu {
    ...
    public List<Button> getButtons(Player player) {
        ...
        for (ItemEditor editor : LootTableHandler.editors) {
