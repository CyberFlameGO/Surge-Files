package dev.lbuddyboy.samurai.util.jpaste.pastebin;

import java.net.MalformedURLException;
import java.net.URL;

import dev.lbuddyboy.samurai.util.jpaste.AbstractPaste;
import dev.lbuddyboy.samurai.util.jpaste.exceptions.PasteException;
import dev.lbuddyboy.samurai.util.jpaste.pastebin.account.PastebinAccount;
...
public class PastebinPaste extends AbstractPaste<PastebinLink> {
	 ...
	 * dev.lbuddyboy.samurai.util.jpaste.pastebin.account.PastebinAccount PastebinAccount}
	 * </p>
	 */
