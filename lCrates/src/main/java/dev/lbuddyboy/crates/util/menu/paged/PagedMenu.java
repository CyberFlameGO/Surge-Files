package dev.lbuddyboy.crates.util.menu.paged;

import dev.lbuddyboy.crates.util.menu.Button;
import dev.lbuddyboy.crates.util.menu.Menu;
import dev.lbuddyboy.crates.util.menu.button.NextPageButton;
import dev.lbuddyboy.crates.util.menu.button.PreviousPageButton;
