...
public class ScheduleCommand extends BaseCommand {
	...
	public static void startdefaults(CommandSender sender) {
		scheduleAdd(sender, "x1-Surge-Key-All", "15m", "crate giveall Surge 1");
		scheduleAdd(sender, "x3-Surge-Key-All", "30m", "crate giveall Surge 3");
		scheduleAdd(sender, "x2-Surge-Key-All", "45m", "crate giveall Surge 2");
		scheduleAdd(sender, "x3-Aura-Key-All", "60m", "crate giveall Aura 3");
		scheduleAdd(sender, "x1-Airdrop-All", "75m", "airdrops giveall 1");
		scheduleAdd(sender, "x1-Ability-Package-All", "90m", "ability giveallpackage 1");
		scheduleAdd(sender, "x2-Ability-Package-All", "1h45m", "ability giveallpackage 2");
