package dev.lbuddyboy.samurai.util.menu;
...
public abstract class Menu {
    ...
    private void update(final Player player) {
        ...
        runnable.runTaskTimer(Samurai.getInstance(), 10L, 10L);
    ...
    static {
        Samurai.getInstance().getServer().getPluginManager().registerEvents(new ButtonListener(), Samurai.getInstance());
