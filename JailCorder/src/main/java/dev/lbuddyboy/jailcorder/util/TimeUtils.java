...
public final class TimeUtils {
    ...
    public static String formatIntoDetailedStringShort(int secs) {
        if (secs == 0) {
            return "0 s";
        } else {
            int remainder = secs % 86400;
    ...
    public static String formatLongIntoDetailedStringShort(long secs) {
        int unconvertedSeconds = (int) secs;
        return formatIntoDetailedStringShort(unconvertedSeconds);
    }
