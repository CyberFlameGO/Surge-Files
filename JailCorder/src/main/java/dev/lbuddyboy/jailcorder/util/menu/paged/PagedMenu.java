package dev.lbuddyboy.jailcorder.util.menu.paged;

import dev.lbuddyboy.jailcorder.util.menu.Button;
import dev.lbuddyboy.jailcorder.util.menu.Menu;
import dev.lbuddyboy.jailcorder.util.menu.button.NextPageButton;
import dev.lbuddyboy.jailcorder.util.menu.button.PreviousPageButton;
