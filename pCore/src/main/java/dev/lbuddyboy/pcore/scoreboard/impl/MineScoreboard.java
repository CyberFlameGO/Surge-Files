...
public class MineScoreboard extends SamuraiScoreboard {
    ...
    public MineScoreboard() {
        this.config = new Config(pCore.getInstance(), "default-mine", pCore.getInstance().getScoreboardHandler().getScoreboardDirectory());
