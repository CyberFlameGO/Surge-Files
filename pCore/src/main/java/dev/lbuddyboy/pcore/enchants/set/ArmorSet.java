package dev.lbuddyboy.pcore.enchants.set;
...
public abstract class ArmorSet implements Listener {
    ...
    public void activate(Player player) {
        player.setMetadata(EnchantHandler.getARMOR_SET_TAG(), new FixedMetadataValue(pCore.getInstance(), true));
        player.setMetadata(getName(), new FixedMetadataValue(pCore.getInstance(), true));
    ...
    public void deactivate(Player player) {
        player.removeMetadata(getName(), pCore.getInstance());
        player.removeMetadata(EnchantHandler.getARMOR_SET_TAG(), pCore.getInstance());
