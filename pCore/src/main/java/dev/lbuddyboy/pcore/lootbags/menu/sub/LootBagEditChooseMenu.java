...
public class LootBagEditChooseMenu extends Menu {
    ...
    public class RenameButton extends Button {
        ...
        public void action(InventoryClickEvent event) throws Exception {
            ...
            player.setMetadata("lootbag_editor_rename", new FixedMetadataValue(pCore.getInstance(), lootBag));
    ...
    public class SetDisplayNameButton extends Button {
        ...
        public void action(InventoryClickEvent event) throws Exception {
            ...
            player.closeInventory();
            player.setMetadata("lootbag_editor_display", new FixedMetadataValue(pCore.getInstance(), lootBag));
