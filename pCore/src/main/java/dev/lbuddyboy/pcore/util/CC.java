...
public class CC {
	...
	public static final Map<String, Color> dyeColors = new HashMap<String, Color>(){{
	...
	public static final Map<Color, String> dyeColorsByColor = new HashMap<Color, String>(){{
		for (Entry<String, Color> entry : dyeColors.entrySet()) {
