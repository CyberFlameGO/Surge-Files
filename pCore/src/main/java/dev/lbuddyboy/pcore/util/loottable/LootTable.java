...
public class LootTable {
    ...
    public LootTable(String name, String displayName, boolean load) {
        this.name = name;
        this.folder = pCore.getInstance().getDataFolder();
        this.displayName = displayName;
        this.config = new Config(pCore.getInstance(), name, folder);
    ...
    public void reload() {
        ...
        this.folder = pCore.getInstance().getDataFolder();
        this.config = new Config(pCore.getInstance(), this.name, this.folder);
        ...
        if (this.config.contains("filler-items")) {
            for (String s : this.config.getStringList("filler-items")) {
                ...
                ItemBuilder builder = new ItemBuilder(Material.getMaterial(parts[0]));
                ...
                if (glowing) builder.addEnchantment(Enchantment.DURABILITY, 1);
    ...
    public void delete() {
        ...
        pCore.getInstance().getLootTableHandler().getLootTables().remove(this);
    }
