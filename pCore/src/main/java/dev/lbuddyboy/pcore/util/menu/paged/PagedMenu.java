package dev.lbuddyboy.pcore.util.menu.paged;

import dev.lbuddyboy.pcore.util.menu.Button;
import dev.lbuddyboy.pcore.util.menu.Menu;
import dev.lbuddyboy.pcore.util.menu.button.NextPageButton;
import dev.lbuddyboy.pcore.util.menu.button.PreviousPageButton;
