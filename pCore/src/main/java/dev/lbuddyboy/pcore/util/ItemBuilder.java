...
public class ItemBuilder {
    ...
    public ItemBuilder setStack(Material material) {
        is.setType(material);
        return this;
    }
    ...
    public ItemBuilder setOwner(String owner) {
        try {
            ItemStack old = this.is.clone();
            ItemStack skull = SkullCreator.itemFromName(owner);
            ItemBuilder builder = new ItemBuilder(skull);

            builder.setName(ItemUtils.getName(old));
            builder.setLore(ItemUtils.getLore(old));
            is = builder.create();
            return builder;
    ...
    public ItemBuilder setOwnerBase64(String base64) {
        try {
            ItemStack old = this.is.clone();
    ...
    public ItemBuilder setOwnerTextureLink(String owner) {
        try {
            ItemStack old = this.is.clone();
            ItemStack skull = SkullCreator.itemFromUrl(owner);
            ItemBuilder builder = new ItemBuilder(skull);
    ...
    public ItemBuilder setOwnerUUID(UUID owner) {
        try {
            ItemStack old = this.is.clone();
            ItemStack skull = SkullCreator.itemFromUuid(owner);
            ItemBuilder builder = new ItemBuilder(skull);
...
/*    public ItemBuilder addEffect(PotionType type, boolean extended, boolean upgraded) {
    ...
    public ItemStack create(ItemStack mirror) {
        this.is = mirror;
        return is;
    }
