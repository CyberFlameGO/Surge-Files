package dev.lbuddyboy.pcore.util.fanciful;
...
import static dev.lbuddyboy.pcore.util.fanciful.TextualComponent.rawText;
...
public class FancyMessage implements JsonRepresentedObject, Cloneable, Iterable<MessagePart>, ConfigurationSerializable {
	 ...
	 * @return This builder instance.
	 */
	public FancyMessage translationReplacements(Object... replacements) {
		for (Object str : replacements) {
			latest().translationReplacements.add(new JsonString(String.valueOf(str)));
		}
		dirty = true;
