package dev.lbuddyboy.bunkers.util.menu.paged;

import dev.lbuddyboy.bunkers.util.menu.Button;
import dev.lbuddyboy.bunkers.util.menu.Menu;
import dev.lbuddyboy.bunkers.util.menu.button.NextPageButton;
import dev.lbuddyboy.bunkers.util.menu.button.PreviousPageButton;
