package dev.lbuddyboy.hub.util.menu.paged;

import dev.lbuddyboy.hub.util.menu.Button;
import dev.lbuddyboy.hub.util.menu.Menu;
import dev.lbuddyboy.hub.util.menu.button.NextPageButton;
import dev.lbuddyboy.hub.util.menu.button.PreviousPageButton;
