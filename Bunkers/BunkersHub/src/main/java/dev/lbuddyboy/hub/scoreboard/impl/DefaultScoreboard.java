...
public class DefaultScoreboard extends HubScoreboard {
    ...
    public DefaultScoreboard() {
        this.config = new Config(lHub.getInstance(), "default", lHub.getInstance().getScoreboardHandler().getScoreboardDirectory());
