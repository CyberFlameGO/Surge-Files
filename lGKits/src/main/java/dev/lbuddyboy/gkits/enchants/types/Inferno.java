 ...
 */
public class Inferno extends CustomEnchant {
	@Override
	public String name() {
		return "inferno";
	}
	...
	public void activate(Player player, ItemStack piece, int level) {
		...
		player.addPotionEffect(new PotionEffect(PotionEffectType.FIRE_RESISTANCE, PotionEffect.INFINITE_DURATION, level - 1));
	}
