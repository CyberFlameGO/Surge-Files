...
public final class SalaryEnchant extends XPrisonEnchantment {
    ...
    public void onBlockBreak(BlockBreakEvent e, int enchantLevel) {
        ...
        plugin.getCore().getGems().getGemsManager().giveGems(e.getPlayer(), (long) randAmount, null, ReceiveCause.MINING);

        if (this.plugin.isAutoSellModuleEnabled()) {
            XPrison.getInstance().getAutoSell().getManager().addToCurrentGems(e.getPlayer(), randAmount);
        }
