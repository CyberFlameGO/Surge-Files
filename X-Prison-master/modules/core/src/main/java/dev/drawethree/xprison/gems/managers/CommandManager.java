...
public class CommandManager {
    ...
    private void registerCommands() {
        ...
        Commands.create()
                .assertPlayer()
                .handler(c -> this.plugin.getGemsManager().toggleLightning(c.sender())).registerAndBind(this.plugin.getCore(), "lightningtoggle");

        Commands.create()
                .assertPlayer()
                .handler(c -> this.plugin.getGemsManager().toggleNuke(c.sender())).registerAndBind(this.plugin.getCore(), "nuketoggle");

        Commands.create()
                .assertPlayer()
                .handler(c -> this.plugin.getGemsManager().toggleMeteor(c.sender())).registerAndBind(this.plugin.getCore(), "meteortoggle");
