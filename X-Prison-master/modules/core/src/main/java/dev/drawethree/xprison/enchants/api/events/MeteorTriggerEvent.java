...
@Getter
public final class MeteorTriggerEvent extends XPrisonPlayerEnchantTriggerEvent {
	 ...
	 */
	public MeteorTriggerEvent(Player p, PrivateMine mine, Block originBlock, List<Block> blocks) {
