...
@Getter
public final class LightningTriggerEvent extends XPrisonPlayerEnchantTriggerEvent {
	 ...
	 */
	public LightningTriggerEvent(Player p, PrivateMine mine, Block originBlock, List<Block> blocks) {
