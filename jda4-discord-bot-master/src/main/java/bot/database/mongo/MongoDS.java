...
public class MongoDS implements DataSource {
    ...
    @Override
    public void addTicketConfig(String guildId, String channelId, String messageId, String title, String generalSupportId, String kitmapSupportId, String practiceSupportId, String bunkersSupportId, String hcfSupportId) {
        ...
        Document doc = new Document()
                ...
                .append("message_id", messageId)
                .append("title", title)
                .append("generalSupportId", generalSupportId)
                .append("kitmapSupportId", kitmapSupportId)
                .append("hcfSupportId", hcfSupportId)
                .append("bunkersSupportId", bunkersSupportId)
                .append("practiceSupportId", practiceSupportId);

        collection.insertOne(doc);
    }

    @Override
    public void updateTicketConfig(String guildId, String channelId, String messageId, String title, String generalSupportId, String kitmapSupportId, String practiceSupportId, String bunkersSupportId, String hcfSupportId) {
        MongoCollection<Document> collection = mongoClient.getDatabase("discord").getCollection("ticket_config");

        Document doc = collection.find(Filters.eq("guild_id", guildId)).first();
        ...
        collection.replaceOne(Filters.eq("guild_id", guildId), doc, new ReplaceOptions().upsert(true));
    }
    ...
    @Override
    public void addExtraConfig(String guildId, String suggestionChannel, String rankRenewalChannel) {
        MongoCollection<Document> collection = mongoClient.getDatabase("discord").getCollection("extra_config");

        Document doc = new Document()
                .append("guild_id", guildId)
                .append("suggestionChannel", suggestionChannel)
                .append("rankRenewalChannel", rankRenewalChannel);

        collection.insertOne(doc);
    }

    @Override
    public void updateExtraConfig(String guildId, String suggestionChannel, String rankRenewalChannel) {
        MongoCollection<Document> collection = mongoClient.getDatabase("discord").getCollection("extra_config");
    ...
    @Override
    public ExtraSettings getExtraConfig(String guildId) {
        MongoCollection<Document> collection = mongoClient.getDatabase("discord").getCollection("extra_config");
        Bson filter = Filters.eq("guild_id", guildId);
        Document document = collection.find(filter).first();
        return document == null ? null : new ExtraSettings(document);
    }

    @Override
    public void deleteExtraConfig(String guildId) {
        MongoCollection<Document> collection = mongoClient.getDatabase("discord").getCollection("extra_config");
        Bson filter = Filters.eq("guild_id", guildId);
        collection.deleteOne(filter);
    }
