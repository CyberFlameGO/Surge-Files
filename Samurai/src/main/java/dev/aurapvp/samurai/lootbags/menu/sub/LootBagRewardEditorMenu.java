...
public class LootBagRewardEditorMenu extends Menu {
    ...
    public class AddItemButton extends Button {
        ...
        public ItemStack getItem() {
            return new ItemBuilder(Material.GREEN_WOOL)
                    ...
                    .setLore("&c&lWARNING! &7This uses your item in your hand.").create();
        }
    ...
    public class RemoveItemButton extends Button {
        ...
        public ItemStack getItem() {
            return new ItemBuilder(Material.RED_WOOL)
                    .setName("&c&lREMOVE ITEM &7(CLICK)").create();
        }
    ...
    public class AddCommandButton extends Button {
        ...
        public ItemStack getItem() {
            return new ItemBuilder(Material.GREEN_WOOL)
                    .setName("&a&lADD COMMAND &7(CLICK)").create();
        }
        ...
        public void action(InventoryClickEvent event) throws Exception {
            ...
            player.setMetadata("lootbag_editor_command", new FixedMetadataValue(Samurai.getInstance(), item));
