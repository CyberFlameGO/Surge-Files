...
public class TierPreviewMenu extends PagedMenu {
    ...
    public List<Button> getGlobalButtons(Player player) {
        ...
        for (int i = 1; i <= 9; i++) {
            if (i == 5) continue;
            buttons.add(Button.fromItem(new ItemBuilder(Material.GRAY_STAINED_GLASS_PANE).create(), i));
        }

        buttons.add(Button.fromItem(new ItemBuilder(Material.GRAY_STAINED_GLASS_PANE).create(), 29));
        buttons.add(Button.fromItem(new ItemBuilder(Material.GRAY_STAINED_GLASS_PANE).create(), 30));
        buttons.add(Button.fromItem(new ItemBuilder(Material.GRAY_STAINED_GLASS_PANE).create(), 31));

        buttons.add(Button.fromItem(new ItemBuilder(Material.GRAY_STAINED_GLASS_PANE).create(), 33));
        buttons.add(Button.fromItem(new ItemBuilder(Material.GRAY_STAINED_GLASS_PANE).create(), 34));
        buttons.add(Button.fromItem(new ItemBuilder(Material.GRAY_STAINED_GLASS_PANE).create(), 35));
