...
public class VaultEconomy extends SkyEconomy implements Economy {

    public VaultEconomy(Map<UUID, BankAccount> accounts) {
        super(accounts);
        Samurai.getInstance().getServer().getServicesManager().register(Economy.class, this, Samurai.getInstance(), ServicePriority.Highest);
    ...
    public EconomyResponse withdrawPlayer(OfflinePlayer offlinePlayer, String s, double v) {
        boolean success = removeMoney(offlinePlayer.getUniqueId(), v, EconomyChange.builder()
                .forced(false)
    ...
    public EconomyResponse depositPlayer(OfflinePlayer offlinePlayer, String s, double v) {
        addMoney(offlinePlayer.getUniqueId(), v, EconomyChange.builder()
                .forced(false)
