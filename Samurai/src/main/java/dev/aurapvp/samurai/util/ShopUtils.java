...
import dev.aurapvp.samurai.shop.ShopItem;
...
public class ShopUtils {
    ...
    public static void process(Player player, ShopItem item, int amount, boolean sell) {
        ...
        if (!sell) {
            boolean success = Samurai.getInstance().getEconomyHandler().getEconomy().removeMoney(
                    player.getUniqueId(),
        ...
        Samurai.getInstance().getEconomyHandler().getEconomy().addMoney(
                player.getUniqueId(),
