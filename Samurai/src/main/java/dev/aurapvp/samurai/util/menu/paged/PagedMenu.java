package dev.aurapvp.samurai.util.menu.paged;

import dev.aurapvp.samurai.util.menu.Button;
import dev.aurapvp.samurai.util.menu.Menu;
import dev.aurapvp.samurai.util.menu.button.NextPageButton;
import dev.aurapvp.samurai.util.menu.button.PreviousPageButton;
...
public abstract class PagedMenu extends Menu {
    ...
    public List<Button> getButtons(Player player) {
        ...
        if (getPreviousButtonSlot() > 0) {
            buttons.add(new PreviousPageButton(this, getPreviousButtonSlot(), player));
        }
        if (getNextPageButtonSlot() > 0) {
