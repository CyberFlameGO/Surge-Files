package dev.aurapvp.samurai.events.citadel;
...
@Getter
public class Citadel extends BukkitRunnable implements Event {
    ...
    private long lastCappedAt;
    private UUID lastCapper;
