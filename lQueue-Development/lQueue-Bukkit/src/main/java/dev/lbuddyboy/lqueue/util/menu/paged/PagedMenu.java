package dev.lbuddyboy.lqueue.util.menu.paged;

import dev.lbuddyboy.lqueue.util.menu.Button;
import dev.lbuddyboy.lqueue.util.menu.Menu;
import dev.lbuddyboy.lqueue.util.menu.button.NextPageButton;
import dev.lbuddyboy.lqueue.util.menu.button.PreviousPageButton;
